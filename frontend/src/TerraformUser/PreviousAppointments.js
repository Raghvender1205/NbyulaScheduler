...
const TerraformUserAppointments = () => {
    const [Appointments, setAppointments] = useState([]);

    const fetchAppointments = async () => {

        const { data } = await Axios.post(
            `${process.env.REACT_APP_SERVER_URL}/terraformUser/previous-appointments/`,
            {
                                ...
                                <tbody>
                                    {Appointments.map((Appointment) => (
                                        <tr key={Appointment._id}>
                                            ...
                                            <th scope="row">{Appointment.terraformName}</th>
                                            <th scope="row">
                                                <div style={{
                                                    display: 'flex'
                                                }}>
...
export default TerraformUserAppointments;