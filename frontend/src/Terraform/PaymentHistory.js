...
const TerraformAppointments = () => {
    ...
    const fetchAppointments = async () => {
        ...
        const { data } = await Axios.post(
            `${process.env.REACT_APP_SERVER_URL}/terraform/previous-appointments/`,
            {
                            ...
                            <table className="table table-hover table-dark">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">TerraformUser Name</th>
                                    ...
                                    {Appointments.map((Appointment) => (
                                        <tr>
                                            ...
                                            {Appointment.feedback.given ? <th scope="row" style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
                                                ...
                                                <Link to={`/terraform/feedback/${Appointment._id}`}>Details</Link>
...
export default TerraformAppointments;